...
val IconGroup.Default.Share: ImageVector
    get() {
        if (_ShareDefault != null) {
            return _ShareDefault!!
        }
        _ShareDefault = ImageVector.Builder(
            name = "ShareDefault",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
...
private var _ShareDefault: ImageVector? = null
