...
val IconGroup.Default.Person: ImageVector
    get() {
        if (_PersonDefault != null) {
            return _PersonDefault!!
        }
        _PersonDefault = ImageVector.Builder(
            name = "PersonDefault",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
...
private var _PersonDefault: ImageVector? = null
