...
import com.bashkevich.tennisscorekeeper.components.ExpandableSection
...
import com.bashkevich.tennisscorekeeper.screens.tournamentdetails.TournamentTabMaxWidth
...
import tennisscorekeeper.shared.generated.resources.couldnt_load_data
import tennisscorekeeper.shared.generated.resources.participant_list_empty
import tennisscorekeeper.shared.generated.resources.pull_down_to_update
import tennisscorekeeper.shared.generated.resources.upload_new_list
    ...
    Column(
        ...
        if (participantListLoadingState.participants.isEmpty()) {
            ...
            if (tournamentStatus == TournamentStatus.NOT_STARTED) {
                ...
                ExpandableSection(
                    modifier = Modifier.widthIn(max = TournamentTabMaxWidth).fillMaxWidth(),
                    title = stringResource(Res.string.upload_new_list),
                    expanded = uploadExpanded,
                    onToggle = { uploadExpanded = !uploadExpanded },
                ) {
                    UploadFileComponent(
